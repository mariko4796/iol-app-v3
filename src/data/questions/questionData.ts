...
・裁縫など細かい作業`,
  ...
  {
    id: "q8",
    title: "Q8：毎日の生活で、一番大切な距離（メガネなしで見たい距離）",
    description: `※今のあなたの生活の中で「最もよく使う距離」を教えてください。`,
    choices: [
      "遠く（約5m以上：道路標識・信号・屋外で人の顔）",
      "少し近い遠く（約2m：テレビ・リビング内）",
      "腕を伸ばしたくらい（約1m：作業台全体・少し離れた手元）",
      "パソコン／料理（約70cm：PC画面・調理台の手元）",
      "読書／スマホ（約40cm：本・スマホの文字）",
      "細かい手元（約33cm：細かい作業・小さい文字）",
    ],
    icon: "blue",
  },
  {
...
export const questionText: Record<QuestionKey, string> = {
  ...
  q6: "Q6：メガネの許容度（全体）",
  q7: "Q7：費用（保険適用）の優先度",
  q8: "Q8：毎日の生活で、一番大切な距離（メガネなしで見たい距離）",
  q9: "Q9：夜間に車の運転をする頻度",
